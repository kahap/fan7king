                ...
                <div class="row">
                    <div class="col-lg-3">
                        <div class="list-group list-menu list-spy">
                            <a href="#z1" class="list-group-item list-group-item-action active">會員註冊</a>
                    ...
                    <div class="col-lg-9">
                        <div id="z1" class="box-faq">
                            <p class="title">會員註冊</p>
                            <div class="accordion accordion-faq" id="accordion1">
                                <div class="card">
                                    <div class="card-header">
                                        <a class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapse1-1">請問申辦分期需要準備什麼文件呢？</a>
                                    </div>
                                    <div id="collapse1-1" class="collapse" data-parent="#accordion1">
                                        <div class="card-body">
                                            請依不同身分別，請您備妥以下資料：<br>
                                            一、學生 :<br>
                                            1.年齡需滿18歲以上，需身分證正反面影本。<br>
                                            2.學生證影本(有蓋註冊章)正反面或(在學證明)或繳款單收據資料。<br>
                                            二、軍人:<br>
                                            1.身分證影本正反面。<br>
                                            2.軍人證影本正反面。<br>
                                            3.近2個月薪餉條或薪轉存摺封面或最近2個月薪轉資料。<br>
                                            三、上班族:<br>
                                            1.身分證正反面影本。<br>
                                            2.個人勞保投保資料 或 薪轉存摺封面及最近2個月整頁薪轉資料。<br>
                                        </div>
                                    </div>
                                </div>
                                <div class="card">
                                    <div class="card-header">
                                        <a class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapse1-2">請問審核的時間大約多久呢?</a>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <a class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapse1-3">我是否可以保留個人隱私不讓親友知道?</a>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <a class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapse1-4">外籍人士能否申辦呢?</a>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <a class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapse1-5">我是學生，但學生証遺失怎麼辦？還能申辦免卡分期嗎？</a>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <a class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapse1-6">如何更新我的個人資料 ? </a>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <a class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapse1-7">我的帳號無法登入 ? </a>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <a class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapse1-8">要如何查詢以往的訂購紀錄呢 ?</a>
                                    </div>
                        ...
                        <div id="z2" class="box-faq">
                            ...
                            <div class="accordion accordion-faq" id="accordion2">
                                <div class="card">
                                    <div class="card-header">
                                        <a class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapse2-1">如果網站上沒有我想要的商品，可以客訂嗎?</a>
                                    </div>
                        ...
                        <div id="z3" class="box-faq">
                            ...
                            <div class="accordion accordion-faq" id="accordion3">
                                <div class="card">
                                    <div class="card-header">
                                        <a class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapse3-1">請問何時會到貨呢?</a>
                                    </div>
                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            <a class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapse3-2">如何查詢目前出貨狀態？</a>
                                        </div>
                                        <div id="collapse3-2" class="collapse" data-parent="#accordion3">
                                            <div class="card-body">
                                                1. 您可以上會員中心【訂單查詢】中查詢出貨狀態，當您的訂單狀態從【核准】到【備貨中】後，約1-3天會變成【出貨中】，當變成【出貨中】時，您就可以點進入訂單查詢，會顯示目前配送的【宅配公司】和【宅配單號】，您就可以上物流公司網站進行查詢目前商品運送狀況！<br>
                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            <a class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapse3-2">完成訂單後還可以更改收貨地址嗎?</a>
                                        </div>
                                        <div id="collapse3-2" class="collapse" data-parent="#accordion3">
                                            <div class="card-body">
                        ...
                        <div id="z4" class="box-faq">
                            ...
                            <div class="accordion accordion-faq" id="accordion4">
                                <div class="card">
                                    <div class="card-header">
                                        <a class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapse4-1">我購買的商品有七天猶豫期嗎?</a>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <a class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapse4-2">商品是正品嗎?</a>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <a class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapse4-3">商品有保固期嗎?</a>
                                    </div>
                        ...
                        <div id="z5" class="box-faq">
                            ...
                            <div class="accordion accordion-faq" id="accordion5">
                                <div class="card">
                                    <div class="card-header">
                                        <a class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapse5-1">購物後何時開始繳款呢?</a>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <a class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapse5-2">如何繳交分期款呢?</a>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <a class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapse5-2">我可以提前結清款項嗎?</a>
                                    </div>
                                    <div id="collapse5-2" class="collapse" data-parent="#accordion5">
                                        <div class="card-body">
                        ...
                        <div id="z6" class="box-faq">
                            ...
                            <div class="accordion accordion-faq" id="accordion6">
                                <div class="card">
                                    <div class="card-header">
                                        <a class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapse6-1">何時會收到發票呢?</a>
                                    </div>
