<?php
	...
	if($errg == ""){
		...
		if($memberData[0]['memEmailAuthen'] == '0' && $memberData[0]['memClass'] == '0'){
			...
			$title = "【NoWait-".$str_title."】".$or_data[0]['orDate'].",流水號:".$_SESSION['ord_code'].",".$memberData[0]['memName']."先生/小姐,訂單編號:".$or_data[0]['orCaseNo'];
			$content = '	
			...
			/**if(in_array("Allan",$receiverNameAndEmails)){
				$ch = curl_init("http://test.nowait.shop/php/index.php?inst=happyfan7&msg=".str_replace(" ","_",$title));
