<?php
	class Admin_Group{
		var $db;
		var $rightArr = array(0=>"摘要資訊",10=>"會員管理-所有會員資訊",11=>"會員管理-機車老客戶查詢",12=>"會員管理-全體簡訊/Email發送",13=>"會員管理-推薦碼獎金撥款",
				14=>"會員資訊-可修改會員",15=>"會員資訊-推薦人清單",20=>"常見問題",30=>"供應商管理",40=>"商品管理",50=>"案件審查時間報表",
				60=>"分期進件:所有狀態",61=>"分期進件:未進件、審查中、補件狀態，客服訂單狀態僅能設【未進件、審查中、待補】",70=>"直購進件",80=>"權限管理",90=>"前台頁面編輯",
				100=>"發票號碼串接",110=>"其餘功能",111=>"更改版本號");
