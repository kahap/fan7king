...
$(function(){
	$("button[type='submit']").click(function(e){
		...
		var url = "ajax/periodSetting/<?php echo $_GET["action"]; ?>.php";
		var redirect = "?page=other&type=periodSetting<?php if($_GET["action"]=="edit") echo "&action=view&psno=".$psNo; if($_GET["action"]=="insert") echo "&pageIndex=last" ?>"
