                ...
                <div class="x_content">
                  ...
                  <div class="form-horizontal form-label-left">
                    ...
                    <div class="form-group not-print">
                      ...
                      <a style="text-decoration:none;" href="?page=other&type=periodSetting2&action=edit&psno=<?php echo $psData[0]["psNo"]; ?>">
...
$(function(){
	$("#content-remove").click(function(){
		if(confirm("確定要刪除此分期計算？")){
			$.ajax({
				type: "POST",
				url: "ajax/periodSetting2/delete.php",
				data: "psNo="+<?php echo $psNo; ?>,
				success: function(result){    
					if(result.indexOf("成功") != -1){
						alert(result);
						location.href = "?page=other&type=periodSetting2";
					}else{
						alert(result);
					}
				}
