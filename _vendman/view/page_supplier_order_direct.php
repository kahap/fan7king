      ...
      <div class="right_col" role="main">
        <div class="">
          ...
          <div class="row">
              ...
              <div class="x_panel">
                <div class="x_content">
                  ...
                  <div class="query-area" style="padding:0 0 20px 0;margin:5px;">
                  	<label>付款狀態： </label>
                  	<select id="whichPayStatus" name="orPaySuccess" class="with-name">
                  		<option <?php if($orPaySuccess == 0) echo "selected"; ?> value="0">未付款</option>
                  		<option <?php if($orPaySuccess == 1) echo "selected"; ?> value="1">已付款</option>
                  	</select>
                  ...
                  <table id="example" class="table bulk_action table-striped responsive-utilities jambo_table">
                    ...
                    ?>
                      <tr class="pointer">
                        ...
                        <td class=" "><?php echo number_format($value[0]["orSupPrice"]); ?></td>
			...
			<iframe style="display:none;" src="view/print_excel_order_direct.php?<?php echo $ulrIframe; ?>"></iframe>
            <br />
            <br />
            <br />
  ...
  <script>
  	$(function(){
		...
		$("#query").click(function(){
			var url = "?page=supplier&action=0";
