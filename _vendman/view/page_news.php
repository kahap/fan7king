        ...
        <div class="">
          <div class="page-title">
            <div class="title_left">
              <h3>最新消息列表</h3>
              <a style="text-decoration:none;" href="?page=other&type=news&action=insert">
                <button class="btn btn-success">新增最新消息</button>
              </a>
            </div>
          </div>
              ...
              <div class="x_panel">
                <div class="x_content">
                  <table id="example" class="table table-striped responsive-utilities jambo_table">
                    ...
                    <?php 
	                    if($allNewsData != null){
	                    	foreach($allNewsData as $key=>$value){
                    ?>
                      <tr class="pointer">
                        <td class=" "><?php echo $value["newsNo"]; ?></td>
                        <td class=" "><?php echo $value["newsTopic"]; ?></td>
                        <td class=" "><?php echo $value["newsDate"]; ?></td>
                        <td class=" last">
	                        <a href="?page=other&type=news&action=view&newsno=<?php echo $value["newsNo"]; ?>">
