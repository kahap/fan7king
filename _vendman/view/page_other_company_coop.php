                  ...
                  <table id="example" class="table table-striped responsive-utilities jambo_table">
                    ...
                    ?>
                      <tr class="pointer">
                        ...
                        <td class=" "><?php echo $value["company_name"]; ?></td>
                        <td class=" "><?php echo $value["contact_name"]; ?></td>
                        <td class=" "><?php echo $value["email"]; ?></td>
                        <td class=" "><?php echo $value["phone"]; ?></td>
                        <td class=" "><?php echo $value["topic"]; ?></td>
                        <td class=" "><?php echo $value["time"]; ?></td>
                        <td class=" last">
	                        <a href="?page=other&type=companyCoop&action=view&id=<?php echo $value["id"]; ?>">
