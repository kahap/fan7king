        ...
        <div class="">
          <div class="page-title">
            <div class="title_left">
              <h3>常見問題列表</h3>
              <a style="text-decoration:none;" href="?page=qanda&action=insert">
                  ...
                  <table id="example" class="table table-striped responsive-utilities jambo_table">
                    ...
                    ?>
                      <tr class="pointer">
						...
						<td class=" ">
							<input type="checkbox" class="status" name="qaIfShow" <?php if($value["qaIfShow"] == 1) echo "checked=true"; ?>>
                        </td>
						<td class=" last">
	                        <a href="?page=qanda&action=view&qano=<?php echo $value["qaNo"]; ?>">
  ...
  <script>
	$(function(){
		$(document).on("change",".status",function(){
			...
			$.post("ajax/qanda/edit_if_show.php", {"qaIfShow":val,"qaNo":qaNo}, function(result){
