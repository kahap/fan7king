...
<!--                                <option value="8">預留2</option>-->
				  ...
				  <div class="form-group">
                      ...
                      <div class="col-md-12 col-sm-6 col-xs-12">
                      	<input value="<?php if($_GET["action"]=="edit") echo $qaData[0]["qaQues"]; ?>" required="required" type="text" class="form-control" name="qaQues" />
                        <ul class="parsley-errors-list"><li id="qaQuesErr"></li></ul>
                      </div>
                  </div>
				  <div class="form-group">
				  ...
				  <div class="x_content">
					...
					<div id="editor"><?php if($_GET["action"]=="edit") echo $qaData[0]["qaAnsw"]; ?></div>
					<textarea name="qaAnsw" id="descr" style="display:none;"></textarea>
					<br />
					<div class="form-group">
                      <label style="font-size:20px;font-weight:initial;" class="control-label col-xs-12" for="first-name">
                      	排序 : 
                      ...
                      <div class="col-md-12 col-sm-6 col-xs-12">
                      	<input value="<?php if($_GET["action"]=="edit") echo $qaData[0]["qaOrder"]; ?>" required="required" type="text" class="form-control" name="qaOrder" />
                        <ul class="parsley-errors-list"><li id="qaQuesErr"></li></ul>
                      </div>
                    </div>
					<div class="form-group">
                      ...
                      <div class="col-md-12 col-sm-6 col-xs-12">
                      	<select name="qaIfShow" class="form-control">
                          <option <?php if($_GET["action"]=="edit" && $qaData[0]["qaIfShow"]==1) echo "selected"; ?> value="1">是</option>
                          <option <?php if($_GET["action"]=="edit" && $qaData[0]["qaIfShow"]==0) echo "selected"; ?> value="0">否</option>
                        </select>
                        <ul class="parsley-errors-list"><li id="qaQuesErr"></li></ul>
                      </div>
                    </div>
  ...
  <script>
    $(document).ready(function() {
		...
		$("button[type='submit']").click(function(e){
			...
			var url = "ajax/qanda/<?php echo $_GET["action"]; ?>.php";
			var redirect = "?page=qanda<?php if($_GET["action"]=="edit") echo "&action=view&qano=".$qaNo; if($_GET["action"]=="insert") echo "&pageIndex=last" ?>";
			...
			$.ajax({
				...
				success:function(result){
					...
					if(results.errMsg != ""){
						addError($("#qaQuesErr"),results.errMsg.qaQuesErr);
