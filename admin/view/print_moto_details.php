...
<div class="page">
	<table>
		<tr class="main-title">
			<td colspan="17"><img id="logo" src="../images/21cent-logo.png">機車貸款申請書</td>
		...
		<tr>
			<td rowspan="4" colspan="4" class="center">貸款內容</td>
			<td colspan="6" class="center">機車廠牌</td>
			<td colspan="4" class="center">CC數</td>
			<td colspan="2" class="center">年分</td>
			<td colspan="4" class="center">車牌號碼</td>
			
		</tr>
		<tr>
			<td style="max-width:100px;" colspan="6" class="center no-bold"><?php echo $orData[0]["mcoMotorBrand"]; ?></td>
			<td colspan="4" class="center no-bold"><?php echo $orData[0]["mcoCcNumber"]; ?></td>
			<td colspan="2" class="center no-bold"><?php echo $orData[0]["mcoYear"]; ?></td>
			<td colspan="4" class="center no-bold"><?php echo $orData[0]["mcoCarNum"]; ?></td>
		</tr>
		<tr>
			<td colspan="4" class="center">分期總金額</td>
			<td colspan="6" class="center">期數</td>
			<td colspan="6" class="center">每期期金</td>
		</tr>
		<tr>
			<td colspan="4" class="center no-bold"><?php echo  number_format($orData[0]["mcoPeriodTotal"]); ?></td>
			<td colspan="6" class="center no-bold"><?php echo $orData[0]["mcoPeriodAmount"]; ?></td>
			<td colspan="6" class="center no-bold"><?php echo $orData[0]["mcoMinMonthlyTotal"]; ?></td>
		</tr>
		<tr>
