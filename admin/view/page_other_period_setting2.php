        ...
        <div class="">
          <div class="page-title">
            <div class="title_left">
              <h3>分期計算列表</h3>
              <a style="text-decoration:none;" href="?page=other&type=periodSetting2&action=insert">
                  ...
                  <table id="example" class="table table-striped responsive-utilities jambo_table">
                    ...
                    ?>
                      <tr class="pointer">
                        ...
                        <td class=" last">
	                        <a href="?page=other&type=periodSetting2&action=view&psno=<?php echo $value["psNo"]; ?>">
