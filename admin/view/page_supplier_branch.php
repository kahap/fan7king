...
$allSupData = $sup->getAllBranchBySupplier($_GET["supno"]);
        ...
        <div class="">
          <div class="page-title">
            <div class="title_left">
              <h3>供應商<?php echo $_GET["supno"];?>分店列表</h3>
                 <a style="text-decoration:none;" href="?page=supplier">
                <button class="btn btn-success">回供應廠清單</button>
              </a>
              <a style="text-decoration:none;" href="?page=supplier&action=branchInsert&supno=<?php echo $_GET['supno'];?>">
                <button class="btn btn-success">新增分店</button>
              </a>
            </div>
          </div>
                  ...
                  <table id="example" class="table table-striped responsive-utilities jambo_table">
                    ...
                    ?>
                      <tr class="pointer">
                        ...
                        <td class=" "><?php if(isset($value["aauName"])){echo $value["aauName"];}; ?></td>
                        <td class=" last">
	                        <a href="?page=supplier&action=branchEdit&ssNo=<?php echo $value["ssNo"]; ?>">
