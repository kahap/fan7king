                  ...
                  <table id="example" class="table bulk_action table-striped responsive-utilities jambo_table">
                    ...
                    ?>
                      <tr class="pointer">
                        ...
                        ?>
                        <td class=" ">
                        	<input type="hidden" name="orNo" value="<?php echo $value["memNo"]; ?>">
                        	<a href="#" class="btn btn-success send-authen">發送驗證</a>
                        	<a href="?page=customer&type=textmsg&memno=<?php echo $value["memNo"]; ?>" class="btn btn-success">簡訊</a>
                        </td>
						<?php
							break;
							case 5:
                        ...
                        <td class=" ">
						<?php 
						if(is_numeric($value["orDocProvideReason"]) && $value["orDocProvideReason"] != "0"){ 
						?>
                        	<a href="#" class="btn btn-success send-again">重發通知信</a>
						<?php 
						}else{ 
							if($value["orDocProvideReason"] != "自訂" && trim($value["orDocProvideComment"]) != ""){
						?>
							<a href="#" class="btn btn-success send-again">重發通知信</a>
						<?php
							}
						...
						<td class=" ">
                        	...
                        	<a href="view/print_order_details.php?orno=<?php echo $value["orNo"]; ?>" target="_blank" class="btn btn-success print">列印</a>
							<?php }else if($value["orIfProcessInCurrentStatus"] == 0){ ?>
							<a href="view/print_order_details.php?orno=<?php echo $value["orNo"]; ?>" target="_blank" class="btn btn-danger print">列印</a>
							<?php } ?>
							<input type="hidden" name="orNo[]" value="<?php echo $value["orNo"]; ?>">
                        </td>
						<?php
                        ...
                        <?php if($status == 0 || $status == 110 || $status == 3 || $status == 4 || $status == 5 || $status == 7 || $status == 10 || $status == 13){ //狀態不可編輯  ?>
                      	...
                      	<?php } ?>
                      	<td class=" "><a data-case="<?php echo $value["orCaseNo"]; ?>" style="color:blue;text-decoration:underline;" target="_blank" href="?page=order&action=view&method=1&orno=<?php echo $value["orNo"]; ?>"><?php echo $value["orCaseNo"]; ?></a></td>
                        <?php 
                        //內部訂單編號 + 補件原因
                        ...
                        ?>
                        	<td class=" ">
                        		<input type="hidden" name="orNo[]" value="<?php echo $value["orNo"]; ?>">
                        		<select name="orDocProvideReason[]" class="which-reason">
                        		  ...
                        		  <label>備註：</label>
                        		  <textarea style="padding:5px;" name="orDocProvideComment[]"><?php echo $value["orDocProvideComment"]; ?></textarea>
                        		</div>
                        	</td>
                        <?php
