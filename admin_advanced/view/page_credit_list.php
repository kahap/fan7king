...
$api->setWhereArray(array("rcStatus"=>2,"rcIfCredit"=>"0","aauNoCredit"=>""));
...
<main class="mn-inner">
	<div class="row">
		<div class="col s12">
			<div class="page-title">徵信作業 - 徵信人員派件</div>
		</div>
				...
				<div class="card-content">
					...
					<div class="input-field col s6">
						<select id="whichAau" name="aauNoCredit">
							...
							<option value="<?php echo $value["aauNo"]; ?>" <?php echo ($_SESSION['adminUserData']['aauNo'] == $value["aauNo"]) ? 'selected':'';?>><?php echo $value["aauName"]; ?> 
							</option>
							<?php } ?>
						</select>
						<label>徵信人員</label>
...
$(function(){
	$(".confirm-save").click(function(){
		if($(".for-checked:checked").length == 0){
			...
			var url = "ajax/credit/insert_new_credit.php";
