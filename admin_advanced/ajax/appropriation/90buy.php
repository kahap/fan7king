...
//業務人員報表
	...
	$sql = "SELECT rcNo,tpiOverdueDays,tpiSupposeDate,tpiPeriod,tpiPeriodTotal FROM `tpi` where datediff('".$_POST['strday']."',tpiSupposeDate) >= 90 && tpiActualDate = '' group by rcNo";
					...
					<div style="padding-bottom:20px;">
   					...
   					<table id="example" class="display responsive-table datatable-example">
						...
						<?php foreach($data as $key => $value){
							$dayNum = datediff($value['tpiSupposeDate'],$_POST['endday']);
							if($dayNum <= "120"){
