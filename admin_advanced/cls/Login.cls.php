...
class Login
{
	...
	*/
    ...
    //    $sql = "select * from admin_advanced_user where aauAccount='".mysqli_real_escape_string($this->db->oDbLink, $username)."' && aauPwd = '".mysqli_real_escape_string($this->db->oDbLink, $password)."' limit 0,1 ";
	  $sql = "select * from admin_advanced_user where aauAccount='".$username."' && aauPwd = '".$password."' limit 0,1 ";
